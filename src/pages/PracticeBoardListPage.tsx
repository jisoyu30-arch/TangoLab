        ...
        {boards.length === 0 ? (
          ...
          >
            ...
            <div className="flex gap-4 mt-4 text-sm text-gray-500">
              <span>저장된 곡: <strong className="text-tango-brass">{board.song_ids.length}</strong></span>
              <span>메모: <strong className="text-tango-brass">{board.notes?.length || 0}</strong></span>
            </div>
