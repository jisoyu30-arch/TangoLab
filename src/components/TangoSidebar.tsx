...
const NAV_ITEMS = [
  ...
  { to: '/results', label: 'Rankings', sub: '대회 순위', num: '04', end: false },
  { to: '/my-competitions', label: 'My Records', sub: '내 대회 기록', num: '05', end: false },
  { to: '/training', label: 'Training', sub: '수업 & 연습', num: '06', end: false },
  { to: '/practice', label: 'Practice', sub: '연습 보드', num: '07', end: false },
  { to: '/compare', label: 'Compare', sub: '비교 연습실', num: '08', end: false },
  { to: '/chat', label: 'Q&A', sub: '탱고 Q&A', num: '09', end: false },
];
