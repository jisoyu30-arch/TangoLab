...
export const CELL_GUIDES: Record<string, { headline: string; points: string[] }> = {
  ...
  // ───── 트래디셔널 (Pugliese / Troilo / D'Agostino) ─────
  'traditional:walk': {
    headline: '정통 마일롱게로 워킹 — 흔들림 없이',
    points: [
      '무릎을 부드럽게 굽힘, 위아래 흔들림 0',
      '아래로 누르는 듯한 정통 워킹',
      '발바닥 전체 안정적으로 닿기',
      '몸통은 차분, 다리만 정확히 — 변형 자제',
    ],
  },
  'traditional:embrace': {
    headline: '클래식 클로즈드 — 가슴 인클라인',
    points: [
      '클로즈드 아브라소 처음부터 끝까지 유지',
      '가슴 살짝 앞으로 기울임 (인클라인)',
      '변치 않는 안정감 — 거리감 변화 거의 없음',
      '아브라소 자체가 곡 전체의 그라운드',
    ],
  },
  'traditional:sequence': {
    headline: '정통 8박 시퀀스 — 정석',
    points: [
      '사카다·옥시오 정석대로, 변형 자제',
      '8박 안에 정확히 끝나는 클래식 단위',
      '오리지널 figura 정확하게 수행',
      '컴비네이션은 단순하지만 매 동작 완성도',
    ],
  },
  'traditional:calesita': {
    headline: '클래식 카레시따 — 안정된 스핀',
    points: [
      '리더가 중심 축, 팔로워가 정확한 원',
      '회전 속도 일정, 가속 없음',
      '발걸음 크기 일정 — 변동 없는 안정',
      '회전 끝에 클래식 finishing pose',
    ],
  },
  'traditional:variation': {
    headline: 'Pugliese arrastre·yumba — 길게 늘이기',
    points: [
      'Yumba 호흡에 맞춰 길게 늘이는 표현',
      'Arrastre(끌기)로 음악 압박감 표현',
      '바리아시옹에서도 정통 라인 유지',
      '강조는 음악 안에서 — 동작을 음악 위로 띄우지 않기',
    ],
  },
};
